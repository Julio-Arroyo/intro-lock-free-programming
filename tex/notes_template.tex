...
\part{Theory}
\input{./chapter/critical_sections.tex}
\input{./chapter/concurrent_objects.tex}
...
\part{Practice}
\input{./chapter/spin_locks_contention.tex}
\input{./chapter/linked_lists.tex}
% \input{./chapter/quantum_field_theory.tex}

\begin{appendices}
% \input{./chapter/appendix_hardware_computer_arch.tex}
\input{./chapter/appendix_std_atomic.tex}
\end{appendices}
